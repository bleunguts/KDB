...
md: delete sym, price from md;
/ required for aj0
md: `sym_market`time xasc md;

/ --- as-of join: bank price -> latest previous market tick
aj0_result: aj0[`sym_market`time; pr; md];
aj0_result: update delta: price - price_market from aj0_result;

/ --- final select
select ptime, sym, price, mtime, sym_market,price_market, delta from aj0_result